...
from src.application.dto.market import CreateOrderDTO, OrderDTO, OrderIdDTO
...
@inject
async def get_order_by_id(id: int, interactor: FromDishka[GetOrderInteractor]) -> OrderDTO:
    try:
